...
entries: map[hash,embed] = {
    "Characters/SRU_OrderMinionSiege/Skins/Skin1" = SkinCharacterDataProperties {
        championSkinName: string = "Order_Minion_Siege_Red"
        ...
        iconCircle: option[string] = {
            "ASSETS/Characters/SRU_OrderMinionSiege/HUD/Redmechcannon_Circle.dds"
        }
        iconSquare: option[string] = {
            "ASSETS/Characters/SRU_OrderMinionSiege/HUD/Redmechcannon_Square.dds"
        }
    }
}
