...
entries: map[hash,embed] = {
    "Characters/Turret/Skins/Skin1" = SkinCharacterDataProperties {
        ...
        skinMeshProperties: embed = SkinMeshDataProperties {
            skeleton: string = "ASSETS/Characters/Turret/Skins/base/Chaos_Turret.skl"
            simpleSkin: string = "ASSETS/Characters/Turret/Skins/base/Chaos_Turret.skn"
        ...
        idleParticlesEffects: list[embed] = {
            SkinCharacterDataProperties_CharacterIdleEffect {
                effectName: string = "Chaos_Turret_Crystal"
