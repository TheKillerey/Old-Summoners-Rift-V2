...
linked: list[string] = {
    ...
    "DATA/Characters/SRU_OrderMinionSiege/Animations/Skin23.bin"
}
entries: map[hash,embed] = {
    0xaba02a36 = SkinCharacterDataProperties {
        championSkinName: string = "Order_Minion_Siege_SRS_Red"
        ...
        skinAnimationProperties: embed = skinAnimationProperties {
            animationGraphData: link = 0x705dd8a3
        }
        skinMeshProperties: embed = SkinMeshDataProperties {
            ...
            texture: string = "ASSETS/Characters/SRU_OrderMinionSiege/Skins/Base/Order_Minion_Siege_TX_CM_Red.dds"
        ...
        iconCircle: option[string] = {
            "ASSETS/Characters/SRU_OrderMinionSiege/HUD/Redmechcannon_Circle.tex"
        }
        iconSquare: option[string] = {
            "ASSETS/Characters/SRU_OrderMinionSiege/HUD/Redmechcannon_Square.tex"
        }
    }
}
