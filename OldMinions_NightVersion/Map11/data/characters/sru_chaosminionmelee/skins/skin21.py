...
entries: map[hash,embed] = {
    "Characters/SRU_ChaosMinionMelee/Skins/Skin21" = SkinCharacterDataProperties {
        championSkinName: string = "Chaos_Minion_Melee_Trueshot_Blue"
        ...
        skinMeshProperties: embed = SkinMeshDataProperties {
            ...
            texture: string = "ASSETS/Characters/SRU_ChaosMinionMelee/Skins/Base/ChaosMinion_Melee_TX_CM_Blue.dds"
        ...
        iconCircle: option[string] = {
            "ASSETS/Characters/SRU_ChaosMinionMelee/HUD/BlueMelee_Circle.tex"
        }
        iconSquare: option[string] = {
            "ASSETS/Characters/SRU_ChaosMinionMelee/HUD/BlueMelee_Square.tex"
        }
    }
}
