...
entries: map[hash,embed] = {
    "Characters/SRU_Blue/Skins/Skin2" = SkinCharacterDataProperties {
        championSkinName: string = "SRU_Blue_Pool_Party"
        ...
        skinMeshProperties: embed = SkinMeshDataProperties {
            skeleton: string = "ASSETS/Characters/SRU_Blue/Skins/Skin02/NSRU_Blue_Pool_Party.skl"
            simpleSkin: string = "ASSETS/Characters/SRU_Blue/Skins/Skin02/NSRU_Blue_Pool_Party.skn"
            ...
            materialOverride: list[embed] = {
                SkinMeshDataProperties_MaterialOverride {
                    texture: string = "ASSETS/Characters/SRU_Blue/Skins/Skin02/SRU_Blue_PoolParty_TX_CM.dds"
                    submesh: string = "SRU_Blue_PoolParty_Mat"
                }
            }
        }
