...
version: u32 = 3
linked: list[string] = {
    "DATA/Characters/SRU_KrugMini/SRU_KrugMini.bin"
    "DATA/Characters/SRU_KrugMini/Animations/Skin0.bin"
}
entries: map[hash,embed] = {
    "Characters/SRU_KrugMini/Skins/Skin0" = SkinCharacterDataProperties {
        championSkinName: string = "SRU_KrugMini"
        skinAudioProperties: embed = skinAudioProperties {
            bankUnits: list2[embed] = {
                BankUnit {
                    name: string = "NPC_Map11_KrugMini_SFX"
                    bankPath: list[string] = {
                        "ASSETS/Sounds/Wwise2016/SFX/Shared/NPC_Map11_KrugMini_SFX_audio.bnk"
                        "ASSETS/Sounds/Wwise2016/SFX/Shared/NPC_Map11_KrugMini_SFX_events.bnk"
                    }
                }
            }
        }
        skinAnimationProperties: embed = skinAnimationProperties {
            animationGraphData: link = "Characters/SRU_KrugMini/Animations/Skin0"
        }
        skinMeshProperties: embed = SkinMeshDataProperties {
            skeleton: string = "ASSETS/Characters/SRU_KrugMini/Skins/Base/SRU_Krug.skl"
            simpleSkin: string = "ASSETS/Characters/SRU_KrugMini/Skins/Base/SRU_Krug.skn"
            texture: string = "ASSETS/Characters/SRU_KrugMiniMini/Skins/Base/SRU_KrugMini_base_TX_CM.dds"
            skinScale: f32 = 1.25
            selfIllumination: f32 = 0.699999988
            material: link = "Characters/SRU_KrugMini/Skins/Skin0/Materials/SR_GoldenKrug"
        ...
        mResourceResolver: link = "Characters/SRU_KrugMini/Skins/Skin0/Resources"
    }
    "Characters/SRU_KrugMini/Skins/Skin0/Resources" = ResourceResolver {
        resourceMap: map[hash,link] = {
            "SRU_KrugMini_Spawn_Mis" = "Characters/SRU_KrugMini/Skins/Skin0/Particles/SRU_KrugMini_Spawn_Mis"
            "SRU_KrugMini_Spawn_Impact" = "Characters/SRU_KrugMini/Skins/Skin0/Particles/SRU_KrugMini_Spawn_Impact"
            "SRU_KrugMini_Death" = "Characters/SRU_KrugMini/Skins/Skin0/Particles/SRU_KrugMini_Death"
        }
    }
    "Characters/SRU_KrugMini/Skins/Skin0/Particles/SRU_KrugMini_Death" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                texture: string = "ASSETS/Characters/SRU_KrugMini/Skins/Base/Particles/SRU_Krug_Death_DustPuffs_2x2.dds"
                numFrames: u16 = 4
                texDiv: vec2 = { 2, 2 }
            }
            VfxEmitterDefinitionData {
                ...
                isSingleParticle: flag = true
                emitterName: string = "LittlePuffs"
            ...
            VfxEmitterDefinitionData {
                ...
                texture: string = "ASSETS/Characters/SRU_KrugMini/Skins/Base/Particles/SRU_Krug_Death_DustSpikes_6x1.dds"
                numFrames: u16 = 6
                texDiv: vec2 = { 6, 1 }
            }
            VfxEmitterDefinitionData {
                ...
                texture: string = "ASSETS/Characters/SRU_KrugMini/Skins/Base/Particles/SRU_Krug_Death_Pebbles_4x4.dds"
                numFrames: u16 = 16
                texDiv: vec2 = { 4, 4 }
            }
            VfxEmitterDefinitionData {
                ...
                isSingleParticle: flag = true
                emitterName: string = "PebblesSmall"
                birthVelocity: embed = ValueVector3 {
                    constantValue: vec3 = { 600, 0, 0 }
                }
                worldAcceleration: embed = IntegratedValueVector3 {
            ...
            VfxEmitterDefinitionData {
                ...
                birthScale0: embed = ValueVector3 {
                    constantValue: vec3 = { 4.5, 3.0999999, 0 }
                    dynamics: pointer = VfxAnimatedVector3fVariableData {
                        probabilityTables: list[pointer] = {
                            VfxProbabilityTableData {
                                keyTimes: list[f32] = {
                ...
                texture: string = "ASSETS/Characters/SRU_KrugMini/Skins/Base/Particles/SRU_Krug_BA_23_Bloodfly.dds"
                numFrames: u16 = 4
            ...
            VfxEmitterDefinitionData {
                ...
                isSingleParticle: flag = true
                emitterName: string = "LittlePuffsGround"
                SpawnShape: pointer = VfxShapeLegacy {
                    emitOffset: embed = ValueVector3 {
                        constantValue: vec3 = { 75, 75, 75 }
                        dynamics: pointer = VfxAnimatedVector3fVariableData {
                ...
                texture: string = "ASSETS/Particles/SRU_Krug_BA_ImpactPuffs_2x2.dds"
                numFrames: u16 = 4
                texDiv: vec2 = { 2, 2 }
            }
        }
        particleName: string = "SRU_KrugMini_Death"
        particlePath: string = "Characters/SRU_KrugMini/Skins/Skin0/Particles/SRU_KrugMini_Death"
        flags: u16 = 198
    }
    "Characters/SRU_KrugMini/Skins/Skin0/Particles/SRU_KrugMini_Spawn_Mis" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 1
                ...
                reflectionDefinition: pointer = VfxReflectionDefinitionData {
                    ...
                    fresnelColor: vec4 = { 0.807843149, 0.474509805, 0.0901960805, 0 }
                }
        ...
        particleName: string = "SRU_KrugMini_Spawn_Mis"
        particlePath: string = "Characters/SRU_KrugMini/Skins/Skin0/Particles/SRU_KrugMini_Spawn_Mis"
        soundOnCreateDefault: string = "Play_sfx_SRU_Krug_golden_impact_cast"
    }
    "Characters/SRU_KrugMini/Skins/Skin0/Particles/SRU_KrugMini_Spawn_Impact" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 10
            ...
            VfxEmitterDefinitionData {
                ...
                blendMode: u8 = 4
                color: embed = ValueColor {
                    constantValue: vec4 = { 1, 0.737254918, 0.309803933, 0.450980395 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.200000003
                        ...
                        values: list[vec4] = {
                            { 1, 0.737254918, 0.309803933, 0.450980395 }
                            { 1, 0.737254918, 0.309803933, 0.450980395 }
                            { 1, 0.737254918, 0.309803933, 0.450980395 }
                            { 1, 0.737254918, 0.309803933, 0 }
                        }
                    }
                }
            ...
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    ...
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        ...
                        values: list[vec4] = {
                            { 0.988235295, 1, 0.690196097, 0.427451015 }
                            { 1, 0.627451003, 0.250980407, 0.427451015 }
                            { 0.847058833, 0.521568656, 0.0666666701, 0 }
                        }
                    }
                }
                isUniformScale: flag = true
        ...
        particleName: string = "SRU_KrugMini_Spawn_Impact"
        particlePath: string = "Characters/SRU_KrugMini/Skins/Skin0/Particles/SRU_KrugMini_Spawn_Impact"
    }
    "Characters/SRU_KrugMini/Skins/Skin0/Materials/SR_GoldenKrug" = StaticMaterialDef {
        name: string = "Characters/SRU_KrugMini/Skins/Skin0/Materials/SR_GoldenKrug"
        samplerValues: list2[embed] = {
            ...
            StaticMaterialShaderSamplerDef {
                ...
                texturePath: string = "ASSETS/Characters/SRU_KrugMini/Skins/Base/SRU_Krug_Base_TX_Mask.dds"
            }
        }
        paramValues: list2[embed] = {
            StaticMaterialShaderParamDef {
                name: string = "EmmisiveFactor"
                value: vec4 = { 0.975000024, 0, 0, 0 }
            }
            StaticMaterialShaderParamDef {
                name: string = "Glow_Intensity"
                value: vec4 = { 0.337500006, 0, 0, 0 }
            }
            StaticMaterialShaderParamDef {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 0.200000003, -0.400000006, 0, 0 }
            }
            StaticMaterialShaderParamDef {
