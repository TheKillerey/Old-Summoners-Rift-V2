...
linked: list[string] = {
    ...
    "DATA/Characters/SRU_OrderMinionRanged/Animations/Skin22.bin"
}
entries: map[hash,embed] = {
    0x88d1aebf = SkinCharacterDataProperties {
        championSkinName: string = "Order_Minion_Ranged_SRS_Blue"
        ...
        skinAnimationProperties: embed = skinAnimationProperties {
            animationGraphData: link = 0xc51b8a7a
        }
