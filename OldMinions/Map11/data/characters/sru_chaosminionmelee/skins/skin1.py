...
entries: map[hash,embed] = {
    "Characters/SRU_ChaosMinionMelee/Skins/Skin1" = SkinCharacterDataProperties {
        championSkinName: string = "Chaos_Minion_Melee_Blue"
        ...
        iconCircle: option[string] = {
            "ASSETS/Characters/SRU_ChaosMinionMelee/HUD/BlueMelee_Circle.dds"
        }
        iconSquare: option[string] = {
            "ASSETS/Characters/SRU_ChaosMinionMelee/HUD/BlueMelee_Square.dds"
        }
    }
}
