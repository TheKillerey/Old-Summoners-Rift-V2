...
linked: list[string] = {
    ...
    "DATA/Characters/SRU_OrderMinionSuper/Animations/Skin23.bin"
}
entries: map[hash,embed] = {
    0x82c684b6 = SkinCharacterDataProperties {
        championSkinName: string = "Order_Minion_Super_SRS_Red"
        ...
        skinAnimationProperties: embed = skinAnimationProperties {
            animationGraphData: link = 0xff2e4823
        }
