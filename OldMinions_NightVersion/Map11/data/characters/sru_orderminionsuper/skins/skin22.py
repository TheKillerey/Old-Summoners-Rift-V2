...
linked: list[string] = {
    ...
    "DATA/Characters/SRU_OrderMinionSuper/Animations/Skin22.bin"
}
entries: map[hash,embed] = {
    0x83c68649 = SkinCharacterDataProperties {
        championSkinName: string = "Order_Minion_Super_SRS_Blue"
        ...
        skinAnimationProperties: embed = skinAnimationProperties {
            animationGraphData: link = 0xfe2e4690
        }
        skinMeshProperties: embed = SkinMeshDataProperties {
            ...
            texture: string = "ASSETS/Characters/SRU_OrderMinionSuper/skins/base/blue_superminion_TX_CM.dds"
        ...
        iconCircle: option[string] = {
            "ASSETS/Characters/SRU_OrderMinionSuper/HUD/Bluemechmelee_Circle.tex"
        }
        iconSquare: option[string] = {
            "ASSETS/Characters/SRU_OrderMinionSuper/HUD/Bluemechmelee_Square.tex"
        }
