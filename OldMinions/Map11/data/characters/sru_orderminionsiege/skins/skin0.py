...
entries: map[hash,embed] = {
    "Characters/SRU_OrderMinionSiege/Skins/Skin0" = SkinCharacterDataProperties {
        championSkinName: string = "Order_Minion_Siege"
        ...
        iconCircle: option[string] = {
            "ASSETS/Characters/SRU_OrderMinionSiege/HUD/Bluemechcannon_Circle.dds"
        }
        iconSquare: option[string] = {
            "ASSETS/Characters/SRU_OrderMinionSiege/HUD/Bluemechcannon_Square.dds"
        }
    }
}
