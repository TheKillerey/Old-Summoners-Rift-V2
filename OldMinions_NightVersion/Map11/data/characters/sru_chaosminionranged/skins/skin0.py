...
entries: map[hash,embed] = {
    "Characters/SRU_ChaosMinionRanged/Skins/Skin0" = SkinCharacterDataProperties {
        championSkinName: string = "Chaos_Minion_Ranged"
        ...
        iconCircle: option[string] = {
            "ASSETS/Characters/SRU_ChaosMinionRanged/HUD/RedRange_Circle.dds"
        }
        iconSquare: option[string] = {
            "ASSETS/Characters/SRU_ChaosMinionRanged/HUD/RedRange_Square.dds"
        }
    }
}
