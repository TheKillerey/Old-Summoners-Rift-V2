...
entries: map[hash,embed] = {
    "Characters/SRU_ChaosMinionSuper/Skins/Skin21" = SkinCharacterDataProperties {
        championSkinName: string = "Chaos_Minion_Super_Trueshot_Blue"
        ...
        iconCircle: option[string] = {
            "ASSETS/Characters/SRU_ChaosMinionSuper/HUD/Bluemechmelee_Circle.tex"
        }
        iconSquare: option[string] = {
            "ASSETS/Characters/SRU_ChaosMinionSuper/HUD/Bluemechmelee_Square.tex"
        }
