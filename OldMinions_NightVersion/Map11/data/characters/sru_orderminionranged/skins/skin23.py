...
linked: list[string] = {
    ...
    "DATA/Characters/SRU_OrderMinionRanged/Animations/Skin23.bin"
}
entries: map[hash,embed] = {
    0x87d1ad2c = SkinCharacterDataProperties {
        championSkinName: string = "Order_Minion_Ranged_SRS_Red"
        ...
        skinAnimationProperties: embed = skinAnimationProperties {
            animationGraphData: link = 0xc61b8c0d
        }
        skinMeshProperties: embed = SkinMeshDataProperties {
            ...
            texture: string = "ASSETS/Characters/SRU_OrderMinionRanged/Skins/Base/OrderMinion_caster_TX_CM_Red.dds"
        ...
        iconCircle: option[string] = {
            "ASSETS/Characters/SRU_OrderMinionRanged/HUD/RedRange_Circle.tex"
        }
        iconSquare: option[string] = {
            "ASSETS/Characters/SRU_OrderMinionRanged/HUD/RedRange_Square.tex"
        }
    }
}
