...
entries: map[hash,embed] = {
    "Characters/SRU_ChaosMinionRanged/Skins/Skin1" = SkinCharacterDataProperties {
        championSkinName: string = "Chaos_Minion_Ranged_Blue"
        ...
        iconCircle: option[string] = {
            "ASSETS/Characters/SRU_ChaosMinionRanged/HUD/BlueRange_Circle.dds"
        }
        iconSquare: option[string] = {
            "ASSETS/Characters/SRU_ChaosMinionRanged/HUD/BlueRange_Square.dds"
        }
    }
}
