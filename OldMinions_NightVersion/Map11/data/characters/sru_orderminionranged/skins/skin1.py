...
entries: map[hash,embed] = {
    "Characters/SRU_OrderMinionRanged/Skins/Skin1" = SkinCharacterDataProperties {
        championSkinName: string = "Order_Minion_Ranged_Red"
        ...
        iconCircle: option[string] = {
            "ASSETS/Characters/SRU_OrderMinionRanged/HUD/RedRange_Circle.dds"
        }
        iconSquare: option[string] = {
            "ASSETS/Characters/SRU_OrderMinionRanged/HUD/RedRange_Square.dds"
        }
    }
}
