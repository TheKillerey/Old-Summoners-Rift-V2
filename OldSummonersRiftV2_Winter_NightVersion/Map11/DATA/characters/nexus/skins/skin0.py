...
entries: map[hash,embed] = {
    "Characters/Nexus/Skins/Skin0" = SkinCharacterDataProperties {
        championSkinName: string = "Nexus_SR_Order_Blue"
