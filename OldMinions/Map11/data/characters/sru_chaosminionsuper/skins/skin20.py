...
entries: map[hash,embed] = {
    "Characters/SRU_ChaosMinionSuper/Skins/Skin20" = SkinCharacterDataProperties {
        championSkinName: string = "Chaos_Minion_Super_Trueshot_Red"
        ...
        iconCircle: option[string] = {
            "ASSETS/Characters/SRU_ChaosMinionSuper/HUD/Redmechmelee_Circle.tex"
        }
        iconSquare: option[string] = {
            "ASSETS/Characters/SRU_ChaosMinionSuper/HUD/Redmechmelee_Square.tex"
        }
