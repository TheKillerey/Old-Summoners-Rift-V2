...
linked: list[string] = {
    ...
    "DATA/Characters/SRU_OrderMinionSiege/Animations/Skin22.bin"
}
entries: map[hash,embed] = {
    0xaca02bc9 = SkinCharacterDataProperties {
        championSkinName: string = "Order_Minion_Siege_SRS_Blue"
        ...
        skinAnimationProperties: embed = skinAnimationProperties {
            animationGraphData: link = 0x6f5dd710
        }
