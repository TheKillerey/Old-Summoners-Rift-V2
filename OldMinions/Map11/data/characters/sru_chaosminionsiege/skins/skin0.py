...
entries: map[hash,embed] = {
    "Characters/SRU_ChaosMinionSiege/Skins/Skin0" = SkinCharacterDataProperties {
        championSkinName: string = "Chaos_Minion_Siege"
        ...
        iconCircle: option[string] = {
            "ASSETS/Characters/SRU_ChaosMinionSiege/HUD/Redmechcannon_Circle.dds"
        }
        iconSquare: option[string] = {
            "ASSETS/Characters/SRU_ChaosMinionSiege/HUD/Redmechcannon_Square.dds"
        }
    }
}
