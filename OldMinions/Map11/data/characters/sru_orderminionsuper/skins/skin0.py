...
entries: map[hash,embed] = {
    "Characters/SRU_OrderMinionSuper/Skins/Skin0" = SkinCharacterDataProperties {
        championSkinName: string = "Order_Minion_Super"
        ...
        iconCircle: option[string] = {
            "ASSETS/Characters/SRU_OrderMinionSuper/HUD/Bluemechmelee_Circle.dds"
        }
        iconSquare: option[string] = {
            "ASSETS/Characters/SRU_OrderMinionSuper/HUD/Bluemechmelee_Square.dds"
        }
