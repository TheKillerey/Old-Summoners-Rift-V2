...
entries: map[hash,embed] = {
    "Characters/SRU_ChaosMinionSiege/Skins/Skin1" = SkinCharacterDataProperties {
        championSkinName: string = "Chaos_Minion_Siege_Blue"
        ...
        iconCircle: option[string] = {
            "ASSETS/Characters/SRU_ChaosMinionSiege/HUD/Bluemechcannon_Circle.dds"
        }
        iconSquare: option[string] = {
            "ASSETS/Characters/SRU_ChaosMinionSiege/HUD/Bluemechcannon_Square.dds"
        }
    }
}
